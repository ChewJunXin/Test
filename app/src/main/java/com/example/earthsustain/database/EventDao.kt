...
interface EventDao {
    ...
    fun updateEvent(organiserEmail: String, eventId: Long, newEventTitle: String, newEventDate: String, newEventDescription: String)
    ...
    fun deleteEvent(organiserEmail: String, eventId: Long)

    // Method to retrieve all events based on joinerEmail
    @Query("SELECT * FROM events WHERE joinerEmail = :joinerEmail")
    fun getEventsByJoinerEmail(joinerEmail: String): List<Event>
    ...
    fun getEventsByJoinerEmailAndStatus(joinerEmail: String, eventStatus: String): List<Event>

    // Method to set eventStatus based on eventId
    @Query("UPDATE events SET eventStatus = :eventStatus WHERE eventId = :eventId")
    fun setEventStatus(eventId: Long, eventStatus: String)
}
